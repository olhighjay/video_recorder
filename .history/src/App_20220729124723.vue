    ...
    <div class="record-page">
      <div class="view-frame-wrapper">
        ...
        <div class="view-frame">
          <video v-if="recorded" controls muted id="my-video-feedback" class=" bg-black w-full h-auto mb-4" style="width:100%; height:100%"></video>
          <video v-else id="vid2" controls class="recorded-video bg-black w-full h-auto mb-8"></video>
        </div>
