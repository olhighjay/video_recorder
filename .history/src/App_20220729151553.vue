    ...
    <div class="record-page">
      <div class="view-frame-wrapper">
        ...
        <div class="text-center start-recording-wrapper">
          <button @click="recordCamVideo" class="start-recording">Start recording</button>
...
export default {
  ...
  methods: {
    ...
    stopAndSaveRecordingCamVideo(vidRecorder) {
      let vidSave = document.getElementById('my-recorded-video');
      let chunks = [];
      vidRecorder.stop();
            vidRecorder.ondataavailable = function(ev) {
              chunks.push(ev.data);
            };
