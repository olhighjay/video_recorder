    ...
    <div class="record-page">
      <div class="view-frame-wrapper">
        ...
        <div class="text-center start-recording-wrapper">
          ...
          <a v-if="downloadable" :href="downloadLink" download="video.mp4" class="my-btn start-recording">Download</a>
          <!-- <button @click="stopAndSaveRecordingCamVideo(mediaVideoRec)" class="start-recording">Stop recording</button> -->
          <!-- <button @click="stopScreenRecording()" class="start-recording">Stop recording</button> -->
        </div>
      </div>
    </div>
  </div>
...
export default {
  ...
  methods: {
    ...
    async startScreenRecording() {
      this.downloadable = false;
      this.recordedVideo = document.getElementById('my-recorded-video');
