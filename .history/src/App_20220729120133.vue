  ...
  <div class="modal-content">
    ...
    <div class="text-center">
      ...
      <div class="record-page">
        <div>
          <!-- <p style="color:#637C8E"> -->
            <i class="fa fa-compact-disc" style="color:#EE5951"></i>
            <div style="border: 2px solid red; border-radius: 50%; height:20px; width:20px">
              <div style="background-color:red; border-radius: 50%; height:12px; width:12px; margin: 10% auto" >jj</div>
            </div>
            Live Preview
          <!-- </p> -->
