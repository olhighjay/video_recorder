    ...
    <div class="record-page">
      <div class="view-frame-wrapper">
        ...
        <div class="view-frame">
          <div v-if="loading" class="d-flex justify-content-center" style="padding-top:25%">
          <h3>Recording</h3><def-loader></def-loader>
          </div>
          <div v-if="myPermissionAccepted" style="height:100%">
          <!-- <div v-if="true" style="height:100%"> -->
            <video v-if="!recorded && cameraMode" controls muted id="my-video-feedback" class=" bg-black w-full h-auto"></video>
...
export default {
  ...
  methods: {
    async startCamVideo() {
      ...
      // // navigator.mediaDevices.getDisplayMedia(vidRecordOptions)
      ...
      //     let stop = document.getElementById('btnStop');
        ...
        err;
        // this.myPermissionAccepted=false;
      }
      console.log('i am'+this.myPermissionAccepted);
    },
    updatePermit(){
      console.log('believe');
