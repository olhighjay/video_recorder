<template>
  <div>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="text-center">
              <button :disabled="!recordVideo && !recordScreen" @click="showRecPage = true" type="button" class="start-recording-btn">Start Recording</button>
            </div>
          </div>
        </div>
        </div>
    ...
    <record-page v-else :recordAudio="recordAudio" :recordVideo="recordVideo" :recordScreen="recordScreen"></record-page>
  </div>
</template>
