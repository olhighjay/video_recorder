<template>
  <div>
    <navbar></navbar>
    <div v-if="!showRecPage" id="main-flex">
        ...
        <div class="my-main-container">
          ...
          <div class="subheading-tab">
            ...
            <div> 
              ...
              <button @click="showList = !showList" class="sub-heading-btn blue-btn">
                <i class="fa fa-video"></i>
                New Request
              </button>
              <button class="sub-heading-btn red-btn" data-toggle="modal"  data-target="#recordOptions">
          ...
          <empty-recorded v-if="!showList"></empty-recorded>
          
          <data-table v-else></data-table>
        ...
        <div class="modal-dialog modal-dialog-centered" role="document">
          <div class="modal-content">
            ...
            <div class="modal-body">
              ...
              <div style="margin-top: 35px;">
                ...
                <div class="record">
                  ...
                  <div class="record-switch">
                    <label class="switch">
                      <input type="checkbox" v-model="recordVideo">
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
                <div class="record">
                  ...
                  <div class="record-switch">
                    <label class="switch">
                      <input type="checkbox" v-model="recordAudio">
                      <span class="slider round"></span>
                    </label>
                  </div>
                </div>
            ...
            <div class="text-center">
              <button :disabled="!recordVideo && !recordScreen" @click="showRecPage = true" type="button" 
              class="start-recording-btn" data-dismiss="modal" aria-label="Close">Start Recording</button>
            </div>
          </div>
        </div>
        </div>
    ...
    <di v-else>
      <record-page :recordAudio="recordAudio" :recordVideo="recordVideo" :recordScreen="recordScreen"></record-page>
    </di>
  </div>
</template>
