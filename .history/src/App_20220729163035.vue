      ...
      <div class="view-frame-wrapper">
        ...
        <div class="view-frame">
          <div v-if="myPermissionAccepted" style="height:100%">
            <video v-show="!recorded" controls muted id="my-video-feedback" class=" bg-black w-full h-auto"></video>
...
export default {
  ...
  methods: {
    ...
    async startScreenRecording() {
      this.recordedVideo = await document.querySelector('.my-recorded-video');
