    ...
    <div class="record-page">
      <div class="view-frame-wrapper">
        ...
        <div class="text-center start-recording-wrapper">
          ...
          <button v-if="recordVideo && (!currentStream || currentStream != 'scnR')" @click="startCamVideo" class="start-recording">Record Camera</button>
          ...
          <button v-if="recordScreen && (!currentStream || currentStream != 'camR')" @click="startScreenRecording" class="start-recording ml-2">Record Screen</button>
